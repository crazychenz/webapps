...
public class BookingDay {
    ...
    public static final String NOT_VALID = "Incorrect Date Format";
    ...
    public boolean isValidDate() {
        ...
        if ((year < 2018 || year > 2025) || (month < 0 || month > 11) || badDay()) {
    ...
    /**
     * Test to see if this BookinDay is after the month and day specified. Note that there is no
    ...
    /**
     * Test to see if this BookinDay is before the month and day specified. Note that there is no
