 ...
 * the premium rate.
 *
 * <p>The premium rate is automatically generated as 1.5x the base rate
 *
 * @author evansrb1
 */
public class Rates {
    ...
    private int calculateCost() {
        ...
        synched = true;
        //     System.out.println("baseRate = " + baseRate + ", premiumRate = " + premiumRate + ",
        // rate = " + rate);
        return rate;
    }
    ...
    public static void main(String[] argv) {
        ...
        System.out.println(
                "start Day of "
                        + startDay
                        + " "
                        + (startDay.isValidDate() ? "is valid" : "is not valid"));
        System.out.println(
                "end Day " + endDay + " " + (endDay.isValidDate() ? "is valid" : "is not valid"));
